...
def identity_block(input_tensor, kernel_size, filters, stage, block):
    ...
    x = Conv2D(
        filters1, (1, 1), data_format=IMAGE_ORDERING, name=conv_name_base + "2a"
    )(input_tensor)
    ...
    x = Conv2D(
        filters3, (1, 1), data_format=IMAGE_ORDERING, name=conv_name_base + "2c"
    )(x)
...
def get_resnet50_encoder(
    ...
    x = Conv2D(
        64, (7, 7), data_format=IMAGE_ORDERING, strides=(2, 2), name="conv1"
    )(x)
    f1 = x
